...
import org.elasticsearch.apack.plain.type.*;
...
public class IndexResolver {
     ...
     */
    public void resolveAsMergedMapping(String[] indices, ActionListener<IndexResolution> listener) {
        FieldCapabilitiesRequest fieldRequest = createFieldCapsRequest(indices);
        client.fieldCaps(fieldRequest,
                ActionListener.wrap(response -> listener.onResponse(mergedMapping(String.join(",", indices), response.get())), listener::onFailure));
    }
    ...
    private static FieldCapabilitiesRequest createFieldCapsRequest(String... indices) {
